...
for (i in 1:10){
  ...
  png(paste("/Users/Pinedasans/Catalyst/Results/MDSplot_perm",i,".png",sep=""))
    COLOR=brewer.pal(3,"Set1")
    MDSplot(rf_output_total, demographics$phenotype[non.list],palette = COLOR,main = paste("Perm",i,sep=""))
    legend("bottomleft", legend=levels(demographics$phenotype[non.list]),col=COLOR, pch = 20)
  dev.off()
}
