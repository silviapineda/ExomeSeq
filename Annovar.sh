...
###For only SNPs
perl convert2annovar.pl -format vcf4 -allsample -withfreq /home/pinedasans/ExomeSeq/VCF/joint.output.snp.indel.recal.filtered.biallelic.SNPs.vcf  > /home/pinedasans/ExomeSeq/VCF/joint.output.recal.filtered.biallelic.SNPs.avinput
...
###For only SNPs
perl table_annovar.pl /home/pinedasans/ExomeSeq/VCF/joint.output.recal.filtered.biallelic.SNPs.avinput humandb/ -buildver hg19 -out myanno.joint.output.recal.filtered.biallelic.SNPs.avinput -remove -protocol refGene,cytoBand,genomicSuperDups,esp6500siv2_all,1000g2014oct_all,1000g2014oct_afr,1000g2014oct_eas,1000g2014oct_eur,snp138,ljb26_all -operation g,r,r,f,f,f,f,f,f,f -nastring . -csvout
