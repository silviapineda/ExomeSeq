...
perl convert2annovar.pl -format vcf4 -allsample -withfreq ../../ExomeSeq/VCF/gVCF/joint.output.snp.indel.recal.filtered.biallelic.SNPs.vcf  > ../../ExomeSeq/ANNOVAR/joint.output.snp.indel.recal.filtered.biallelic.SNPs.avinput

#Create the annotation
perl table_annovar.pl /home/pinedasans/ExomeSeq/ANNOVAR/joint.output.snp.indel.recal.filtered.biallelic.SNPs.avinput humandb/ -buildver hg19 -out myanno.joint.output.snp.indel.recal.QC.avinput -remove -protocol refGene,cytoBand,genomicSuperDups,esp6500siv2_all,1000g2014oct_all,1000g2014oct_afr,1000g2014oct_eas,1000g2014oct_eur,snp138,ljb26_all -operation g,r,r,f,f,f,f,f,f,f -nastring . -csvout